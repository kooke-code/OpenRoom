...
const APP_STATIC_REGISTRY: AppStaticDef[] = [
  ...
  {
    appId: 21,
    appName: 'operationsDashboard',
    route: '/operationsDashboard',
    displayName: 'Operations',
    sourceDir: 'OperationsDashboard',
    icon: 'ShieldAlert',
    color: '#ef4444',
  ...
  {
    appId: 22,
    appName: 'tradingTerminal',
    route: '/tradingTerminal',
    displayName: 'Trading',
    sourceDir: 'TradingTerminal',
    icon: 'TrendingUp',
    color: '#22c55e',
  ...
  {
    appId: 24,
    appName: 'escalationCenter',
    route: '/escalationCenter',
    displayName: 'Escalations',
    sourceDir: 'EscalationCenter',
    icon: 'AlertTriangle',
    color: '#eab308',
  ...
  {
    appId: 25,
    appName: 'storeIntelligence',
    route: '/storeIntelligence',
    displayName: 'Stores',
    sourceDir: 'StoreIntelligence',
    icon: 'Building2',
    color: '#f97316',
    defaultSize: { width: 850, height: 650 },
  },
  ...
  {
    appId: 28,
    appName: 'companyDashboard',
    route: '/companyDashboard',
    displayName: 'Company',
    sourceDir: 'CompanyDashboard',
    icon: 'Briefcase',
    color: '#0ea5e9',
    defaultSize: { width: 800, height: 650 },
  },
  {
    appId: 29,
    appName: 'ventureTracker',
    route: '/ventureTracker',
    displayName: 'Ventures',
    sourceDir: 'VentureTracker',
    icon: 'Rocket',
    color: '#f43f5e',
    defaultSize: { width: 850, height: 650 },
  },
